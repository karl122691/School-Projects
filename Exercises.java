...
JOptionPane.showMessageDialog(null,String.format("%d raised to %d is equal to: %.2f",base,exponent,result));
    ...
    public static void minmax(){{
        ...
        if (max<maximum){
         ...
         switch(minmax){
             case -1: break;
             case 0:        JOptionPane.showMessageDialog(null, message + min);
             break;
             case 1 : JOptionPane.showMessageDialog(null, message + max);
             break;
         }
    ...
    public static void sum(){
        ...
        ave = sum/numbers.length;
         ...
         switch(sumave){
             case -1: break;
             case 0:        JOptionPane.showMessageDialog(null, messagesum);
             break;
             case 1 : JOptionPane.showMessageDialog(null, messageave);
             break;
             case 2:
